...
dense_lstm_net = [
    dict(type='internal_lstm', size=16) #dropout=0.4 internal_lstm
]
...
agent = TRPOAgent(
    ...
    #likelihood_ratio_clipping=0.01,
    #PGModel
)

#agent.restore_model(directory = 'champion')
...
def episode_finished(r):
    ...
    if(iter == batch_size):
        iter = 0
        agent.save_model('TPRO_lstm_16_fasza_extendprofit_new_rewrads/dense_mix')

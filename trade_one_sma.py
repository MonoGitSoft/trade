...
dense_lstm_net = [
    dict(type='internal_lstm', size=128) #dropout=0.4
]
...
#agent.restore_model(directory = 'sma_lstm_small_prevent_16_16_16_entropy_reg_overfiiting')
...
def episode_finished(r):
    ...
    if(iter == batch_size):
        iter = 0
        agent.save_model('sma_lstm_onesmal_cute/dense_mix')
